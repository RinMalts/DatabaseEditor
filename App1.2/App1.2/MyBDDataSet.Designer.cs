...
namespace App1._2 {
    ...
    public partial class MyBDDataSet : global::System.Data.DataSet {
        ...
        public partial class STOREDataTable : global::System.Data.TypedTableBase<STORERow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public STORERow AddSTORERow(string name, int price) {
        ...
        public partial class STORERow : global::System.Data.DataRow {
            ...
            public int price {
                get {
                    try {
                        return ((int)(this[this.tableSTORE.priceColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace App1._2.MyBDDataSetTableAdapters {
    ...
    public partial class STORETableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[STORE] WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND" +
                " [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_price = 1 AND [pric" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[STORE] ([name], [price]) VALUES (@name, @price);\r\nSELECT id, n" +
                "ame, price FROM STORE WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[STORE] SET [name] = @name, [price] = @price WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)));
SELECT id, name, price FROM STORE WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, price FROM dbo.STORE";
        ...
        public virtual int Fill(MyBDDataSet.STOREDataTable dataTable) {
        ...
        public virtual MyBDDataSet.STOREDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MyBDDataSet.STOREDataTable dataTable = new MyBDDataSet.STOREDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyBDDataSet.STOREDataTable dataTable) {
